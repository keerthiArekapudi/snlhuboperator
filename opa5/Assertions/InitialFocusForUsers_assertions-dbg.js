       ...
       iSeeFocusOnSearchField : function(){
           return this.waitFor({
               ...
               check : function(oSearchField){
                   return sap.ui.test.Opa5.getWindow().sap.ui.getCore().getCurrentFocusedControlId()==="MyContactsMaster--sapSplSearchMyUsersMasterList";
               },
               success : function(){
                   ok(sap.ui.test.Opa5.getWindow().sap.ui.getCore().getCurrentFocusedControlId()==='MyContactsMaster--sapSplSearchMyUsersMasterList',"Focus is on the element"+ " " +"- Search Field");
               },
       ...
       iSeeFocusOnNameField : function() {
           return this.waitFor({
               ...
               check : function(oInput){
                   return sap.ui.test.Opa5.getWindow().sap.ui.getCore().getCurrentFocusedControlId()==="NewContactRegistrationDetail--sapSplMyUserFirstNameInput";
               },
               success : function(oInput){
                   ok(sap.ui.test.Opa5.getWindow().sap.ui.getCore().getCurrentFocusedControlId()==='NewContactRegistrationDetail--sapSplMyUserFirstNameInput',"Focus is on the right element"+ " " +"- Name Field");
               },
               errorMessage :"Focus on the wrong element" + " " + sap.ui.test.Opa5.getWindow().sap.ui.getCore().getCurrentFocusedControlId()
           });
       }
